...
**Skipped / optional:** Phase 5 accessibility — not required for this closed ~25-player squad app used by able-bodied adults on their own phones. Skip link is already done; only revisit fieldset/ARIA/focus trap if something bothers someone in real use.
...
gantt
    ...
    Vitest pool forks (Windows fix)   :done, p2a, 2026-06-20, 1d
